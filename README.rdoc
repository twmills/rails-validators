...
class Pet
  ...
  validates :nick_name, :presence => true, :length => {:within => 2..12}, :person_name => true
end
...
To finetune the name validators, add a validators.rb initializer file

NameValidator.name_length 3..40
